...
struct ModernFieldExamples {
    ...
    static func createPolygonField() -> Field {
        ...
        let norm = FieldNorm(sosAvgDOY: 120, peakAvgDOY: 200, eosAvgDOY: 280, losAvgDays: 160, peakNdviAvg: 0.85)
        let deviation = Deviation(daysSOS: -5, daysPeak: 10, daysEOS: 15, daysLOS: 20, peakNdvi: 0.02)
        let current = CurrentData(sos: "2025-04-30", peakDate: "2025-07-19", eos: nil, los: nil, peakNdvi: 0.87, deviation: deviation)
    ...
    static func createSimplePolygonField() -> Field {
        ...
        let norm = FieldNorm(sosAvgDOY: 100, peakAvgDOY: 180, eosAvgDOY: 260, losAvgDays: 160, peakNdviAvg: 0.80)
        let deviation = Deviation(daysSOS: 0, daysPeak: -3, daysEOS: 5, daysLOS: 5, peakNdvi: 0.05)
        let current = CurrentData(sos: "2025-04-10", peakDate: "2025-06-27", eos: "2025-09-17", los: 165, peakNdvi: 0.85, deviation: deviation)
    ...
    static func createRectangularField() -> Field {
        ...
        let norm = FieldNorm(sosAvgDOY: 130, peakAvgDOY: 210, eosAvgDOY: 290, losAvgDays: 160, peakNdviAvg: 0.82)
        let deviation = Deviation(daysSOS: nil, daysPeak: nil, daysEOS: nil, daysLOS: nil, peakNdvi: 0.84)
        let current = CurrentData(sos: "2025-05-10", peakDate: nil, eos: nil, los: nil, peakNdvi: 0.84, deviation: deviation)
    ...
    static func createPointField() -> Field {
        ...
        let norm = FieldNorm(sosAvgDOY: 110, peakAvgDOY: 190, eosAvgDOY: 270, losAvgDays: 160, peakNdviAvg: 0.75)
        let deviation = Deviation(daysSOS: 5, daysPeak: -2, daysEOS: 0, daysLOS: -5, peakNdvi: 0.10)
        let current = CurrentData(sos: "2025-04-20", peakDate: "2025-07-08", eos: nil, los: nil, peakNdvi: 0.85, deviation: deviation)
    ...
    static func createMultiPolygonField() -> Field {
        ...
        let norm = FieldNorm(sosAvgDOY: 140, peakAvgDOY: 220, eosAvgDOY: 300, losAvgDays: 160, peakNdviAvg: 0.88)
        let deviation = Deviation(daysSOS: -10, daysPeak: 5, daysEOS: 10, daysLOS: 15, peakNdvi: -0.03)
        let current = CurrentData(sos: "2025-05-20", peakDate: nil, eos: nil, los: nil, peakNdvi: 0.85, deviation: deviation)
